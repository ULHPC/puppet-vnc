...
By default, the [puppet-vnc](https://github.com/ULHPC/puppet-vnc) repository is bound to the [ulhpc-puppet-vnc](http://ulhpc-puppet-vnc.rtfd.org) project on Read the Docs (to avoid confusion with other vnc projects). 
